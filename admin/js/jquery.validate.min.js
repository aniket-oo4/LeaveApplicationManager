    ...
    t.extend(t.fn, {
        ...
        rules: function(e, i) {
            ...
            if (null != h && null != h.form) {
                ...
                return a = t.validator.normalizeRules(t.extend({}, t.validator.classRules(h), t.validator.attributeRules(h), t.validator.dataRules(h), t.validator.staticRules(h)), h),
    ...
    t.extend(t.validator, {
        ...
        prototype: {
            ...
            element: function(e) {
                ...
                s && t.each(this.groups, function(t, e) {
                    e === s && t !== n.name && (r = a.validationTargetFor(a.clean(a.findByName(t))),
                    r && r.name in a.invalid && (a.currentElements.push(r),
                    o = a.check(r) && o))
                }),
                i = this.check(n) !== !1,
                o = o && i,
                this.invalid[n.name] = i ? !1 : !0,
            ...
            elements: function() {
                ...
                return t(this.currentForm).find("input, select, textarea, [contenteditable]").not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function() {
                    ...
                    s in i || !e.objectLength(t(this).rules()) ? !1 : (i[s] = !0,
                    !0)
                })
            },
            clean: function(e) {
            ...
            elementValue: function(e) {
                ...
                return "radio" === n || "checkbox" === n ? this.findByName(e.name).filter(":checked").val() : "number" === n && "undefined" != typeof e.validity ? e.validity.badInput ? "NaN" : r.val() : (i = e.hasAttribute("contenteditable") ? r.text() : r.val(),
                "file" === n ? "C:\\fakepath\\" === i.substr(0, 12) ? i.substr(12) : (s = i.lastIndexOf("/"),
                s >= 0 ? i.substr(s + 1) : (s = i.lastIndexOf("\\"),
                s >= 0 ? i.substr(s + 1) : i)) : "string" == typeof i ? i.replace(/\r/g, "") : i)
            },
            check: function(e) {
                ...
                for (s in n) {
                    ...
                    try {
                        if (i = t.validator.methods[s].call(this, l, e, r.parameters),
            ...
            showLabel: function(e, i) {
                ...
                o.html(i)) : (o = t("<" + this.settings.errorElement + ">").attr("id", l + "-error").addClass(this.settings.errorClass).html(i || ""),
                s = o,
        ...
        normalizeRules: function(e, i) {
            return t.each(e, function(s, r) {
                ...
                if (r.param || r.depends) {
                    ...
                    n ? e[s] = void 0 !== r.param ? r.param : !0 : (t.data(i.form, "validator").resetElements(t(i)),
                    delete e[s])
                }
            }),
        ...
        methods: {
            ...
            step: function(e, i, s) {
                var r, n = t(i).attr("type"), a = "Step attribute on input type " + n + " is not supported.", o = ["text", "number", "range"], l = new RegExp("\\b" + n + "\\b"), h = n && !l.test(o.join()), u = function(t) {
                    var e = ("" + t).match(/(?:\.(\d+))?$/);
